...
function FetchImage(image: string, prototype: Prototype | undefined): string {
    let imageId = image;
    if (image){
...
export function ImageDisplay(props: {image: string, size?: number|string, prototype?: Prototype, errorImage?: string}){
    let imageResolved = FetchImage(props.image, props.prototype);
